...
function CardOrders({imageUrl,name,price,model,year,id,refresh}) {
        ...
        <div style={{margin:"20px"}}>
            <Paper style={{width:"200px",padding:"20px"}}>
                ...
                <Wraper >
                    ...
                    <Button id={id} onClick={(e) => handleClick(e)} style={{backgroundColor:"crimson"}} variant="contained">DELETE</Button>
